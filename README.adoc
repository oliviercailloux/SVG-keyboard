...
The described keyboard behavior is the one that the operating system sees. It is not a goal to represent the internal electronics of the keyboard, such as how “link:https://en.wikipedia.org/wiki/Fn_key#Technical_details[meta-modifier]” keys change the signals that other keys send to the operating system.
